...
public class NewsActivity extends Activity implements Constants.AppConstants {
     ...
     * @Override public void onFinish(int requestCode) { // TODO Auto-generated
     * method stub }
     * @Override public void onFinish(int responseCode, Object result) { // TODO
     * Auto-generated method stub if (UtilValidate.isNotNull(result) &&
     * responseCode == REQUEST_CODE) { NewsBase newsBase = (NewsBase)result; if
     * (UtilValidate.isNotNull(newsBase)) { if
     * (UtilValidate.isNotEmpty(newsBase.getHeadlines())) {
     * newsHeadlinesList.addAll(newsBase.getHeadlines()); loadingFinished =
     * false; // SHOW LOADING IF IT ISNT // ALREADY // VISIBLE
     * relativeLayoutprogresswheel.setVisibility(View.INVISIBLE);
     * progressBarDetail_text.setVisibility(View.INVISIBLE);
     * pbHeaderProgress.setVisibility(View.INVISIBLE); newsAdapter = new
     * NewsAdapter(NewsActivity.this, newsHeadlinesList);
     * listView_newslist.setAdapter(newsAdapter); listView_newslist
     ...
     * relativeLayoutprogresswheel.setVisibility(View.INVISIBLE);
     * progressBarDetail_text.setVisibility(View.INVISIBLE);
     * pbHeaderProgress.setVisibility(View.INVISIBLE); newsDetailList = new
     * ArrayList<String>(); newsDetailList.add(newsHeadlinesList.get(position)
     * .getHeadline()); newsDetailList.add(newsHeadlinesList.get(position)
     * .getDescription()); newsDetailList.add(newsHeadlinesList.get(position)
     * .getSource()); newsDetailList.add(newsHeadlinesList.get(position)
     * .getLastModified()); newsDetailList.add(newsHeadlinesList.get(position)
     * .getImages().get(0).getUrl()); Intent intent = new
     * Intent(NewsActivity.this, NewsDetailpageActivity.class); Bundle value =
     * new Bundle(); value.putStringArrayList("newsDetailList",
     * (ArrayList<String>)newsDetailList); intent.putExtras(value);
     * startActivity(intent); } }); } } } }
     * @Override public void onFinish(int responseCode, String result) { // TODO
     * Auto-generated method stub
     * relativeLayoutprogresswheel.setVisibility(View.INVISIBLE);
     * progressBarDetail_text.setVisibility(View.INVISIBLE);
     * pbHeaderProgress.setVisibility(View.INVISIBLE); NoInternetpopup(); }
     * @Override public void onFinish(int responseCode, Object result, int
     * requestCode) { // TODO Auto-generated method stub }
     * @Override public void onFinish(int responseCode, Object result, boolean
     * isPaginated) { // TODO Auto-generated method stub } }
     */
    ...
    public void NoInternetpopup() {
        ...
        TextView textView_nointernet = (TextView)popupView.findViewById(R.id.textView_nointernet);
    ...
    private class ScrappingnewsTask extends AsyncTask<Void, String, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            newsList = newsManager.scrapUrlForNews(URL_NEWS_FROM_GOAL);

            Log.e("fdsfsdfsdf", "newsList  :" + newsList.size());
        ...
        protected void onPostExecute(String result) {
            ...
            // if(UtilValidate.isNotEmpty(newsList))
