...
public class VenueDao implements Constants {
    ...
    public List<com.jn.kickoff.holder.Venue> getAllVenues() {

        List<com.jn.kickoff.holder.Venue> venueList = new ArrayList<com.jn.kickoff.holder.Venue>();
            ...
            try {
                ...
                if (cursor.getCount() > 0) {
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        com.jn.kickoff.holder.Venue venue = new com.jn.kickoff.holder.Venue();
